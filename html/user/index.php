...
function show_nav() {
    ...
    if ($no_computing) {
        ...
        echo "
            Russian Words Compatibility is a research project 
            that uses Internet-connected
            computers to do research in russian computational linguistics.
    ...
    echo "
        <p>
        <h2 class=headline>Our results</h2>
        <ul>
    ";

    echo "
        <li> <a href=\"show_results.php\">Show results</a>
    ";
